...
Route::middleware('admin')->prefix('admin')->name('admin.')->group(function () {
	...
	Route::get('/manage-company-location/{id}', [MasterController::class, 'manage_location'])->name('manage-company-location');
	Route::post('/manage-company-location/{id}', [MasterController::class, 'manage_location'])->name('manage-company-location');
	//-----
	...
	Route::get('/manage-location-wise-subcategory-subchecklist/{id}', [SubChecklistController::class, 'index'])->name('manage-location-wise-subcategory-subchecklist');
	...
	Route::post('/subchecklist-orderno-update', [SubChecklistController::class, 'subchecklist_orderno_update'])->name('subchecklist-orderno-update');
