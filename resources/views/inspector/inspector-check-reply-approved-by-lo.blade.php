				...
				<div class="container1">
					<div class="custom-tab" style="margin-bottom: 80px;">
						...
						<div class="row IA-IOS-get-reply">
							...
							<div class="col-md-6 text-ia-lo-los d-flex justify-content-between flex-wrap"><span>By {{ $userData->get_user->name ?? ''}} </span><span>{{ change_date_format($created_at, 'Y-m-d H:i:s', 'd M Y, h:i A')}}</span></div>
						</div>
