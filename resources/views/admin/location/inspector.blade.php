			...
			<div class="col-lg-6 mb-2">
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li><a class="dropdown-item" onclick="change_multi_status('1','Inspector','{{url('admin/change-multi-status')}}')">Active</a></li>
						<li><a class="dropdown-item" onclick="change_multi_status('0','Inspector','{{url('admin/change-multi-status')}}')">Inactive</a></li>
						<li><a class="dropdown-item" onclick="delete_multi_data('Inspector','{{url('admin/delete-multi-data')}}')">Delete</a></li>
					</ul>
				</div>
			</div>
		@endif
