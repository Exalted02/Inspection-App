		...
		<div class="modal-content">
			<div class="modal-body">
				<div class="success-message text-center">
					...
					<p>{{ __('management_name') }} "<span id="list_name"></span>" {{ __('from_your_account') }}</p>
					<div class="col-lg-12 text-center form-wizard-button">
						<a href="#" class="button btn-lights" data-bs-dismiss="modal">{{ __('not_now') }}</a>
						<a href="javascript:void(0);" class="btn btn-primary data-id-list" data-url="{{ route('admin.deletemanagementList') }}">{{ __('okay') }}</a>
					</div>
				</div>
			</div>
		</div>
...
<div id="add_management" class="modal custom-modal fade" role="dialog">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form id="frmmanagement" action="{{ route('admin.save-management') }}" enctype="multipart/form-data">
								<input type="hidden" id="id" name="id">
									<div class="row">
										<div class="col-sm-6">
											<div class="input-block mb-3">
												<label class="col-form-label">{{ __('management_name') }}<span class="text-danger">*</span></label>
									...
									<div class="submit-section">
										<button class="btn btn-primary submit-btn save-management" type="button">Submit</button>
									</div>
								</form>
							</div>
						</div>
