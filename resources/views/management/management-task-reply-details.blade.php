...
@endphp
	...
	{{--<h2 class="checklist-title">{{ $tab == 'corrective-action' ? 'Agree of corrective action' : 'Corrective check' }} plan</h2>--}}
		<h2 class="checklist-title">Respirator User Has Training Sticker On Employee Badge</h2>
			...
			<section class="custom-padding1">
				<div class="container1">
					<div class="custom-tab" style="margin-bottom: 80px;">
						...
						@if(!empty($image_arr))
							<div class="d-flex flex-wrap gap-2 mb-3" style="margin-left: 85px;">
								@foreach($image_arr as $url)
									<div class="cheklist-reply-images">
										<img src="{{ $url['url'] ?? '' }}" style="max-width: 150px; height: auto;">
									</div>
								@endforeach
							</div>
						@endif
						...
						<div class="d-flex align-items-start mb-3">
							...
							<div class="owner-checklist">
								...
								<div class="mt-4">
									Completed on: 21 Feb 2025, 2:21 PM
								</div>
							</div>
						</div>
						...
						<div class="d-flex align-items-start mb-3 flex-wrap" style="margin-left: 2rem;">
						  ...
						  <div class="owner-checklist">
							<label><strong>Aggrement corrective action</strong></label>
						  </div>
						</div>
						...
						<div class="d-flex align-items-start mb-3 flex-wrap" style="margin-top: 3rem;">
							...
							<div class="owner-checklist">
								<label class="d-block mb-2 fw-bold">Pending Martin to upload checks result</label>
